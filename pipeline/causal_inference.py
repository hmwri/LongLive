...
class CausalInferencePipeline(torch.nn.Module):
    def __init__(
        ...
        wan_model_dir = getattr(args, "wan_model_dir", None)
        self.generator = WanDiffusionWrapper(
            **getattr(args, "model_kwargs", {}), is_causal=True, model_dir=wan_model_dir) if generator is None else generator
        self.text_encoder = WanTextEncoder(model_dir=wan_model_dir) if text_encoder is None else text_encoder
        self.vae = WanVAEWrapper(model_dir=wan_model_dir) if vae is None else vae
